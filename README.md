...
| 🛒 **Global Book Sales**       | Batch processing pipeline with Airflow Spark, analyzing on BigQuery, dashboard on Looker Studio.  | [Repository](https://github.com/supakunz/Book-Revenue-Pipeline.git)  |
